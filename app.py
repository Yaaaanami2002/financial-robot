...
def server(input, output, session):
    ...
    def ai_industry_explanation():
        ...
        return ui.div(
            ...
            # 使用 ui.div 包裹 HTML 内容并设置样式
            ui.div(
                HTML(html_content),
                style="white-space: pre-wrap; word-break: break-word; padding: 10px; background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 4px;"
            )
        )
    ...
    def result_output():
        ...
        if identifier:
            ...
            if not filtered_df.empty:
                ...
                return ui.div("未找到匹配的公司信息。")
        return ui.div("请输入股票代码或公司名称。")
